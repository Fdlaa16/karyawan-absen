      ...
      <div class="card border shadow-xs mb-4">
        <div class="card-body text-start p-3 w-100">
          ...
          <div class="row">
            <div class="col-12">
              <div class="w-100">
                <p class="text-sm text-secondary mb-1">Absensi</p>
                <h4 class="mb-2 font-weight-bold">123</h4>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="card border shadow-xs mb-4">
        <div class="card-body text-start p-3 w-100">
          ...
          <div class="row">
            <div class="col-12">
              <div class="w-100">
                <p class="text-sm text-secondary mb-1">Kehadiran</p>
                <h4 class="mb-2 font-weight-bold">456</h4>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-12">
              <div class="w-100">
                ...
                <h4 class="mb-2 font-weight-bold">789</h4>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="card border shadow-xs mb-4">
        <div class="card-body text-start p-3 w-100">
          ...
          <div class="row">
            <div class="col-12">
              <div class="w-100">
                <p class="text-sm text-secondary mb-1">Group Karyawan</p>
                <h4 class="mb-2 font-weight-bold">098</h4>
              </div>
            </div>
          </div>
        </div>
