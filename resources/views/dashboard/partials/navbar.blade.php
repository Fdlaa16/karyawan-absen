<nav class="navbar navbar-main navbar-expand-lg mx-5 px-0 shadow-none rounded" id="navbarBlur" navbar-scroll="true">
    <div class="container-fluid py-1 px-2">
      <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bold mb-0">@yield('page_title', 'Dashboard')</h6>
    </nav>
        ...
        <ul class="navbar-nav  justify-content-end">
          ...
          <li class="nav-item dropdown pe-2 d-flex align-items-center">
            ...
            <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
              <li class="mb-2">
                <a href="{{ url('/profile')}}" class="dropdown-item border-radius-md" href="javascript:;">
                  <div class="d-flex py-1">
                    <div class="my-auto">
                      <i class="fas fa-user col-sm-12 border-radius-sm  me-3"></i>
                    </div>
              ...
              <li class="mb-2">
                <a href="{{ url('/logout')}}" class="dropdown-item border-radius-md">
                  <div class="d-flex py-1">
                    <div class="my-auto">
                      <i class="fas fa-power-off col-sm-12 border-radius-sm  me-3"></i>
                    </div>
                    <div class="d-flex flex-column justify-content-center">
                      <h6 class="text-sm font-weight-normal mb-1">
