<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
  <div class="d-flex align-items-center justify-content-center mt-3 mb-3">
    <img src="{{ asset('assets/img/spx.jpg') }}" style="width: 40px; margin-right: 3%;">
        <span class="font-weight-bold text-white">Shopee Express</span>
  </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link {{ Request::is('employee*') ? 'active' : '' }}" href="/employee">
            <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
              <i class="fas fa-user" style="color: blueviolet;"></i>
            </div>
            <span class="nav-link-text ms-1">Karyawan</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ Request::is('employeeGroup*') ? 'active' : '' }}" href="/employeeGroup">
            <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
              <i class="fas fa-user-group" style="color: blueviolet;"></i>
            </div>
            <span class="nav-link-text ms-1">Grup Karyawan</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ Request::is('shift*') ? 'active' : '' }}" href="/shift">
            <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
              <i class="fas fa-clock" style="color: blueviolet;"></i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link {{ Request::is('cuti*') ? 'active' : '' }}" href="/cuti">
            <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
              <i class="fas fa-check" style="color: blueviolet;"></i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link {{ Request::is('laporan*') ? 'active' : '' }}" href="/laporan">
            <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
              <i class="fas fa-book" style="color: blueviolet;"></i>
            </div>
            <span class="nav-link-text ms-1">Pengajuan laporan</span>
          </a>
        </li>
        @endif
        @if(Gate::check('hr'))
        ...
        <li class="nav-item">
          <a class="nav-link {{ Request::is('approval-cuti*') ? 'active' : '' }}" href="/approval-cuti">
            <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
              <i class="fas fa-book" style="color: blueviolet;"></i>
            </div>
            <span class="nav-link-text ms-1">Approval Cuti Karyawan</span>
          </a>
        </li>
        @endif
      </ul>
